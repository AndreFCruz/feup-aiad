 ...
 * Tests DefaultNode.
 *
 * @version $Revision: 1.1 $ $Date: 2004/10/19 18:13:00 $
 */
public class DefaultNodeTest extends TestCase {
  ...
  public void testRandomRewire() {
    ...
    Random.setSeed(1000);
    Random.createUniform();
    List nodeList = NetworkFactory.getNetwork("test/uchicago/src/sim/network/krackhardt_advice.dl",
                                              NetworkFactory.DL,
                                              DefaultNode.class,
                                              DefaultEdge.class,
  ...
  public static junit.framework.Test suite() {
    return new TestSuite(uchicago.src.sim.network.DefaultNodeTest.class);
  }
}
